...
resource: https://getknot.dev/reference/events/json-rpc-sinks/
sources:
    - resource: https://getknot.dev/reference/events/json-rpc-sinks/
status: stable
tags:
...
Uses the same Go template engine and variables as [Webhook Sinks](webhook-sinks.md). Available scopes: `.event`, `.space`, `.actor`, `.custom`.
