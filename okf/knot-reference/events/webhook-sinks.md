...
resource: https://getknot.dev/reference/events/webhook-sinks/
sources:
    - resource: https://getknot.dev/reference/events/webhook-sinks/
status: stable
tags:
...
Fields that are defined on the template but not set on the space render as empty strings. See [Custom Variables](../../knot-docs/variables/custom-variables.md) for how to define custom fields on templates.
