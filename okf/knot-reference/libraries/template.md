...
- `kvm_network_mode` - KVM templates only: `bridged` (static IPs from the template's range) or `nat` (libvirt NAT, DHCP) — see the [VM specification](../../knot-docs/templates/kvm-templates/vm-spec.md)
