...
resource: https://getknot.dev/reference/libraries/healthcheck/
sources:
    - resource: https://getknot.dev/reference/libraries/healthcheck/
status: stable
tags:
