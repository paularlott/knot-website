...
resource: https://getknot.dev/reference/libraries/plugin/
sources:
    - resource: https://getknot.dev/reference/libraries/plugin/
status: stable
tags:
...
- [MCP Tools — calling plugins from tools](../../knot-docs/plugins/writing-plugins/mcp-tools.md) — the trust boundary the two transports draw.
- [Plugin Pages](../../knot-docs/plugins/writing-plugins/pages.md) — the handler-URL and gate contract underneath every call.
