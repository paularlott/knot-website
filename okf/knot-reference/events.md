...
resource: https://getknot.dev/reference/events/
sources:
    - resource: https://getknot.dev/reference/events/
status: stable
tags:
...
- [Webhook Sinks](events/webhook-sinks.md) — POST events to an HTTP endpoint with a templated body
- [Script Sinks](events/script-sinks.md) — Run a scriptling script server-side with event accessors
- [JSON-RPC Sinks](events/json-rpc-sinks.md) — Named formatters that deliver events to running script methods
