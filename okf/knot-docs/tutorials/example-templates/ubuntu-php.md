...
resource: https://getknot.dev/docs/tutorials/example-templates/ubuntu-php/
sources:
    - resource: https://getknot.dev/docs/tutorials/example-templates/ubuntu-php/
status: stable
tags:
...
The space exposes **port 80** via the web interface, which can be accessed from the space's [web interface](../../spaces/web-server.md).
