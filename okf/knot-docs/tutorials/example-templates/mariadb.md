...
resource: https://getknot.dev/docs/tutorials/example-templates/mariadb/
sources:
    - resource: https://getknot.dev/docs/tutorials/example-templates/mariadb/
status: stable
tags:
...
The space exports the **MariaDB port 3306** via the TCP proxy, allowing it to be connected to using [port forwarding](../../spaces/port-forwarding.md). For example:
