---
description: Deploy a Valkey server as the storage database for knot on Nomad with Podman.
generated:
    by: knot-website/okf.py
resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/podman/database/
sources:
    - resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/podman/database/
status: stable
tags:
