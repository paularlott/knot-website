---
description: Deploy the CephFS CSI driver with Podman to mount shared filesystems into spaces.
generated:
    by: knot-website/okf.py
resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/podman/csi-drivers/cephfs/
sources:
    - resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/podman/csi-drivers/cephfs/
status: stable
tags:
