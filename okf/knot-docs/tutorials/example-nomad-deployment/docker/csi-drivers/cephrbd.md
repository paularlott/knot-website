...
resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/docker/csi-drivers/cephrbd/
sources:
    - resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/docker/csi-drivers/cephrbd/
status: stable
tags:
...
Below is the Nomad job specification for deploying the **Ceph RBD controller**:
...
Below is the Nomad job specification for deploying the **Ceph RBD node**:
