---
description: Deploy the hostpath CSI driver for simple, single-server storage.
generated:
    by: knot-website/okf.py
resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/docker/csi-drivers/hostpath/
sources:
    - resource: https://getknot.dev/docs/tutorials/example-nomad-deployment/docker/csi-drivers/hostpath/
status: stable
tags:
