...
resource: https://getknot.dev/docs/tutorials/example-local-deployment/
sources:
    - resource: https://getknot.dev/docs/tutorials/example-local-deployment/
status: stable
tags:
...
Follow the quick start guide to [Create the Admin User](../quick-start/local-containers/create-admin-user.md).
