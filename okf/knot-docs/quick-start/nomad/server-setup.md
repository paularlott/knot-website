...
resource: https://getknot.dev/docs/quick-start/nomad/server-setup/
sources:
    - resource: https://getknot.dev/docs/quick-start/nomad/server-setup/
status: stable
tags:
...
**Knot Pro** : Replace `paularlott/knot:latest` with `paularlott/knot-pro:latest` and add your license configuration. See [Pro Installation](../pro-installation.md) for details.
