...
resource: https://getknot.dev/docs/quick-start/local-containers/server-setup/
sources:
    - resource: https://getknot.dev/docs/quick-start/local-containers/server-setup/
status: stable
tags:
...
**Knot Pro** : If you are using [Knot Pro](../pro-installation.md), run the same command — `knot server --config knot.toml` — with your Pro license key set in `knot.toml`.
...
- [Creating the Admin User](create-admin-user.md)
