...
resource: https://getknot.dev/docs/variables/user-defined-variables/
sources:
    - resource: https://getknot.dev/docs/variables/user-defined-variables/
status: stable
tags:
...
For secrets that should remain outside the **knot** database entirely, use [Secret Providers](secret-providers.md). 
