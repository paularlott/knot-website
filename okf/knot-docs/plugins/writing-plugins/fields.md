...
resource: https://getknot.dev/docs/plugins/writing-plugins/fields/
sources:
    - resource: https://getknot.dev/docs/plugins/writing-plugins/fields/
status: stable
title: Fields
...
The `demo-scriptling` example declares a working `field_environment`. For a full handler against real live data, see the [scriptling](scriptling.md#fields) walkthrough.
