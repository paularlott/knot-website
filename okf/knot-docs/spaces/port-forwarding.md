...
resource: https://getknot.dev/docs/spaces/port-forwarding/
sources:
    - resource: https://getknot.dev/docs/spaces/port-forwarding/
status: stable
tags:
...
For port forwarding between spaces within the same zone, see [Space-to-Space Port Forwarding](space-space-port-forwarding.md).
