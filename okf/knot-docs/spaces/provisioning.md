...
resource: https://getknot.dev/docs/spaces/provisioning/
sources:
    - resource: https://getknot.dev/docs/spaces/provisioning/
status: stable
tags:
...
This runs first in the [execution order](startup-scripts.md#script-execution-order), before user startup scripts and file-based scripts.
...
Provisioning scripts can read [variables](../variables.md) to adapt configuration per space or environment:
...
- [Startup & Shutdown Scripts](startup-scripts.md) - Script execution lifecycle
- [Variables](../variables.md) - Per-space and global configuration
- [Script Examples](../scripting/examples.md) - More scriptling examples
