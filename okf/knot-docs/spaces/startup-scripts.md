...
resource: https://getknot.dev/docs/spaces/startup-scripts/
sources:
    - resource: https://getknot.dev/docs/spaces/startup-scripts/
status: stable
tags:
...
See [Scripting](../scripting.md) for complete library availability.

---

## Best Practices

1. **Keep scripts idempotent**: Scripts should handle being run multiple times safely. Use `scriptling.provision.file` for file operations -- see [Provisioning](provisioning.md) for the recommended pattern
...
- [Provisioning](provisioning.md) - Idempotent file provisioning with `scriptling.provision.file`
