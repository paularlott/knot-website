...
resource: https://getknot.dev/docs/stacks/
sources:
    - resource: https://getknot.dev/docs/stacks/
status: stable
tags:
...
- [Stack Template Format](stacks/definitions.md) — TOML file format and options
- [Using Stacks](stacks/using-stacks.md) — Creating and managing stacks from templates
