...
resource: https://getknot.dev/docs/configuration/local-containers/
sources:
    - resource: https://getknot.dev/docs/configuration/local-containers/
status: stable
tags:
...
- **[Cluster Operations](cluster-mode.md)**: Exposing runtime capabilities across the cluster
...
This preference is applied when automatically selecting a server for deployment. See [Node Selection](node-selection.md) for more details on how spaces are assigned to servers.
