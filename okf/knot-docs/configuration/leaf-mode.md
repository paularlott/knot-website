...
resource: https://getknot.dev/docs/configuration/leaf-mode/
sources:
    - resource: https://getknot.dev/docs/configuration/leaf-mode/
status: stable
tags:
...
Templates can be configured to be available only on leaf nodes or excluded from leaf nodes using the reserved **`<leaf-node>`** zone name. For more information, see [Limit to Zones](../templates/managing.md#zones-and-access-control) in the Managing Templates documentation.
