...
resource: https://getknot.dev/docs/ai/skills/
sources:
    - resource: https://getknot.dev/docs/ai/skills/
status: stable
tags:
...
- [AI Assistant](ai-assistant.md) - Using the built-in AI assistant
- [MCP Integration](mcp.md) - Connecting external AI tools
- [Scripting](../scripting.md) - Creating executable automation scripts
