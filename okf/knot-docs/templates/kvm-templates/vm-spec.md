...
resource: https://getknot.dev/docs/templates/kvm-templates/vm-spec/
sources:
    - resource: https://getknot.dev/docs/templates/kvm-templates/vm-spec/
status: stable
tags:
...
| `bridge` | optional | Host bridge name, default `br0`. Must exist on the node with the physical NIC enslaved (see [KVM nodes](../../configuration/kvm.md#bridged-networking)) |
