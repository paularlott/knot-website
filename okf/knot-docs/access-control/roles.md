...
resource: https://getknot.dev/docs/access-control/roles/
sources:
    - resource: https://getknot.dev/docs/access-control/roles/
status: stable
tags:
...
Knot Pro adds one further permission — **Use Log Sinks**, running a space that receives the logs of your other spaces. 
