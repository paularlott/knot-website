...
resource: https://getknot.dev/docs/
sources:
    - resource: https://getknot.dev/docs/
status: stable
tags:
...
Choose your path: [Local Containers](quick-start/local-containers.md) | [Nomad](quick-start/nomad.md) | [Quick Start](quick-start.md)
...
- [Reference](../knot-reference/knot-reference.md) — CLI, architecture, scripting libraries, events, API tokens, and glossary
