...
resource: https://getknot.dev/docs/tunnels/agent-tunnels/
sources:
    - resource: https://getknot.dev/docs/tunnels/agent-tunnels/
status: stable
tags:
...
from [desktop tunnels](agent-tunnels.md), which run as a foreground process on your local
...
[API Tokens](../api-tokens.md#scoping-a-token).
