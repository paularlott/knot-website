...
See the [scriptling.provision.file reference](/reference/libraries/provision-file/) for the full API including `absent`, `ensure_directory`, and `absent_directory`.
...
- [scriptling.provision.file Reference](/reference/libraries/provision-file/) - Full API documentation
